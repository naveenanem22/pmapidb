...
INSERT INTO `itshelpdeskattachment` VALUES (11,'80C-House_Princ_HL-Provisional-2018-2019.pdf'),(12,'HL-Provisional-2018-2019.pdf'),(15,'hlintcertificate_navarum.pdf'),(16,'homeloancertificate_96154558.pdf'),(13,'Huntington_Issues.txt'),(14,'IT_Report.pdf'),(17,'RE_ _ITS Helpdesk_ new ticket - Need webex account.msg');
...
INSERT INTO `ticket` VALUES (3,'Need internet conneciton to Personal device','Need internet conneciton to Personal device as per project demand.',1,1,1,1,1,6,'2018-11-02 04:51:28','2019-03-01 12:12:43',1),(4,'Unable to connect to VDI','Unable to Connect to clients VDI on wifi.',1,1,2,1,1,3,'2018-11-02 04:51:28','2019-07-09 04:50:59',4),(5,'sdfsd','dfs',3,3,1,3,1,5,'2019-02-27 07:47:39','2019-07-09 04:50:55',3),(6,'Need extra monitor','Need extra monitor to extend the display from laptop',1,2,1,2,1,4,'2019-02-27 09:28:30','2019-02-27 09:28:30',1),(7,'System is performing at the slowest best','Its not working now...',1,2,2,3,1,2,'2019-03-03 11:04:58','2019-03-03 11:04:58',4),(8,'Just a sample','klsdjflksdjflsdk',1,3,2,4,1,5,'2019-03-25 12:48:59','2019-03-25 12:48:59',3),(9,'Testing the flow','Testing the flow',1,1,1,1,1,5,'2019-03-27 08:30:00','2019-03-26 03:02:53',1),(10,'jlkdfsd','',2,4,2,3,3,5,'2019-04-03 12:45:41','2019-06-01 12:00:16',4),(11,'Need additional seats for new resources','Need additional seats for new resources due to recruitment',2,1,1,3,4,5,'2019-04-25 02:50:33','2019-07-10 00:40:42',3),(12,'Manager Create Ticket Test','Manager Create Ticket Test',1,1,1,1,4,2,'2019-04-25 07:27:06','2019-05-26 23:50:08',1),(13,'Create Ticket Form UI In Progress','Create Ticket Form UI In Progress',1,1,1,1,3,5,'2019-05-03 06:20:21','2019-06-17 23:20:29',4),(14,'Toggle testing New Ticket','The test is to check if the Success or Failure alert not displaying during Fresh New Ticket Form.',2,4,1,2,3,5,'2019-05-03 12:43:50','2019-06-18 00:23:57',3),(15,'Test for dismiss alert to navigate to MyTickets','Test for dismiss alert to navigate to MyTickets',1,1,2,2,3,5,'2019-05-03 12:47:18','2019-06-17 23:17:36',1),(16,'Create Ticket Form UI In Progresssss','Create Ticket Form UI In Progresssss',1,2,1,2,3,5,'2019-05-05 02:51:06','2019-06-01 22:42:02',1),(17,'Testing the reaload','Testing the reaload',2,1,2,1,3,5,'2019-05-05 02:52:38','2019-06-17 23:30:18',4),(18,'Trying reload','Trying reload',2,4,1,2,3,2,'2019-05-05 02:56:25','2019-05-30 23:16:44',3),(19,'Fixed reload my tickets','Fixed reload my tickets',1,4,2,4,3,2,'2019-05-05 02:58:21','2019-05-31 00:12:47',1),(20,'Create Ticket Form UI In Progress','New ticket for mousenot working',2,1,1,3,3,2,'2019-05-17 00:00:33','2019-06-13 03:32:24',4),(21,'Need new laptop','Need new laptop',2,4,2,2,4,2,'2019-05-20 04:20:36','2019-06-10 05:10:37',3),(22,'Ticket to check if On and Off Success Alert','Testing to see if Success alert is visible',2,2,2,3,4,2,'2019-05-30 07:49:57','2019-05-30 07:50:37',1),(23,'Verify the changes from Manager role','Verify the changes from Manager role as well. To ensure that the changes done in manager section are reflected in here.',3,4,2,3,3,1,'2019-05-31 22:31:43','2019-05-31 22:31:43',4),(24,'Employee view is completed','Employee view is completed. Next is to Workflow and Policy pages.',2,4,1,4,3,1,'2019-06-15 04:08:15','2019-06-15 04:08:15',4),(25,'Need new keyboard for the purpose of testing the site','As per the project, need new keyboard.',1,1,1,4,3,2,'2019-07-02 12:52:18','2019-07-04 06:21:38',3),(26,'Testing the ticket with hamburger menu','Testing the ticket with hamburger menu',2,4,1,3,3,1,'2019-07-03 00:15:53','2019-07-03 00:15:53',4),(27,'Test to check if this is coming in Manager\'s list','Test to check if this is coming in Manager\'s list',2,1,1,3,3,1,'2019-07-04 08:58:35','2019-07-04 08:58:35',NULL),(28,'Ticket to check if it is coming under manager\'s list','Ticket to check if it is coming under manager\'s list',3,2,2,3,3,2,'2019-07-04 09:08:01','2019-07-04 09:08:58',3),(29,'To be found in last hour tickets','To be found in last hour tickets',2,4,2,3,4,2,'2019-07-09 04:45:19','2019-07-09 09:32:01',4);
...
INSERT INTO `ticketassignment` VALUES (2,6,2,'2019-02-27 09:28:30'),(3,6,2,'2019-03-27 09:28:30'),(4,7,2,'2019-03-27 09:28:30'),(5,6,2,'2019-02-28 09:28:30'),(6,6,2,'2018-02-27 09:18:30'),(7,7,2,'2019-04-27 09:28:30'),(8,6,2,'2019-02-27 09:20:30'),(9,6,2,'2018-03-27 09:28:30'),(10,6,2,'2019-04-27 09:28:30'),(11,7,2,'2019-05-27 09:28:30'),(12,6,2,'2019-04-27 08:28:30'),(13,7,2,'2019-06-27 09:28:30'),(14,3,1,'2019-06-27 09:28:30'),(15,5,2,'2019-07-27 09:28:30'),(16,11,2,'2019-08-27 09:28:30'),(17,14,1,'2019-08-27 09:28:30'),(21,10,1,NULL),(22,12,1,NULL),(23,13,1,NULL),(24,14,1,NULL),(25,16,1,NULL),(26,17,1,NULL),(27,18,1,NULL),(28,20,1,NULL),(29,19,1,NULL),(30,21,1,NULL),(31,19,1,NULL),(32,17,1,NULL),(33,18,1,NULL),(34,19,1,NULL),(35,21,1,NULL),(36,20,1,NULL),(37,16,1,NULL),(38,17,1,NULL),(39,18,1,NULL),(40,19,1,NULL),(41,20,1,NULL),(42,21,1,NULL),(43,16,1,NULL),(44,18,1,NULL),(45,17,1,NULL),(46,20,1,NULL),(47,19,1,NULL),(48,21,1,NULL),(49,18,1,NULL),(50,19,1,NULL),(51,20,1,NULL),(52,21,1,NULL),(53,17,1,NULL),(54,22,1,NULL),(55,18,1,NULL),(56,19,1,NULL),(57,21,1,NULL),(58,20,1,NULL),(59,25,1,NULL),(60,28,1,NULL),(61,29,1,NULL);
...
INSERT INTO `tktconvattachment` VALUES (1,19,11),(2,19,12),(3,21,13),(4,26,14),(5,58,15),(6,58,16),(7,62,17);
...
-- Dump completed on 2019-07-15 17:00:44
